...
<html>
	...
	<body>
		<header>
			...
			<a id="fav" href="ShowFavorites">Favorites</a>
			<a id="movie" href="ShowMovieListCustomer">Movies</a>
		...
		<div class="cont">
			...
			<h3>
				...
				<tr>
					...
					<td class="centr"><a href="RemoveFavorites?movieItemId=${movie.id }">Delete</a></td>
				...
				<tr>
					<th class="titles"><b>No. of Favorites: </b>${fn:length(movieItemList)}</th>
